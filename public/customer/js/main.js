;(function($) {
  ...
  $(document).ready(function() {
     ...
     * Promotion Popup
     * ---------------------------*/
    let promotionPrevent = window.localStorage.getItem('promotionPrevent');
    if ($('.promotion-popup').length > 0 && !promotionPrevent) {
      setTimeout(function() {
   ...
   ---------------------*/
    ...
    $('.cart-banner .hover-state a').on('click', function(e) {
      e.preventDefault();
      $('.cart-page-banner-bg img').attr('src', $(this).attr('href'));
    });
    ...
    $('.product-reviews > .owl-carousel, .service-reviews > .owl-carousel').owlCarousel({
      loop: true,
      margin: 20,
      autoplay: false,
      autoplayTimeout: 4000,
    ...
    $('.product-comments > .owl-carousel, .service-comments > .owl-carousel').owlCarousel({
      loop: true,
      margin: 20,
      autoplay: false,
      autoplayTimeout: 4000,
